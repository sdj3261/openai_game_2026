...
[브라우저에서 바로 플레이](https://sdj3261.github.io/openai_game_2026/) · [게임 디자인](./docs/GAME_DESIGN.md) · [기술 아키텍처](./docs/TECHNICAL_ARCHITECTURE.md) · [시스템 디자인 DOCX](./docs/GAIA_2126_SYSTEM_DESIGN.docx) · [에셋 출처와 Vision 검수](./docs/ASSET_PROVENANCE.md) · [보안 검토](./docs/SECURITY_REVIEW.md) · [Codex 협업 기록](./docs/CODEX_COLLABORATION.md) · [제출/시연 자료](./docs/SUBMISSION.md)
