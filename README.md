...
> 데모 영상은 기존 최종본을 유지합니다. v0.14.0 게임도 영상과 같은 `Z 경비원 도발`, `X 분신 만들기`를 사용하며, 분신의 열쇠 획득과 단순화된 재시작·게임 메뉴를 지원합니다. 사망 모달은 게임 화면의 잘림 영역 밖에 배치해 PC와 모바일에서 항상 표시됩니다.
...
v0.14.0 자동 검사는 단위 테스트 총 58개와 정적 빌드 스모크 검사로 구성됩니다.
